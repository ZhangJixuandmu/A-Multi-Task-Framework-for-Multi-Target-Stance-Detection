    ...
    for target_index in range(len(target_word_pair)):
        ...
        for seed in random_seeds:
            ...
            if train_mode == "unified":
                ...
                filename2 = '../data/raw_train_all_onecol.csv'
                filename3 = '../data/raw_train_all_onecol.csv'
            ...
            optimizer_grouped_parameters = [{'params': [p for n,p in model.named_parameters() if n.startswith('bert.encoder')], 'lr':lr},
            ...
            for epoch in range(0,total_epoch):
                ...
                for input_ids,seg_ids,atten_masks,target,length,input_ids2,target2 in trainloader:
                    ...
                    nn.utils.clip_grad_norm_(model.named_parameters(), 1)
                    optimizer.step()
